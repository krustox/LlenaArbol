...
<?php include('../head.php');?>
	<body>
		<div id="wrapper">
			...
			<div id="container">
			<h2>Transaccion</h2>
			<a href="Crear_Transaccion.php">Crear Transaccion</a>
				...
				<table id="table">
					...
					<tr>
						...
						<th>Display Transaccion</th>
						<th>Accion</th>
					</tr>
					</thead>
					<tbody>
				<?php
				$query= "Select * from \"servicios\".\"transaccion\"";
					 ...
					 if($resp){
						 ...
						 if ($result) {
					 	 	while ($row = db2_fetch_array($result)) {
       						...
       						<td width="25%"><?php echo "<a onclick=\"eliminar('$row[0]','$row[1]','transaccion')\">Eliminar</a>"; ?></td>
       						</tr><?php
      						}
						 }else{
