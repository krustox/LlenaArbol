...
<?php include('../head.php');?>
	<body>
		<div id="wrapper">
			...
			<div id="container">
			<h2>Agrupacion</h2>
			<a href="Crear_Agrupacion.php">Crear Agrupacion</a>
...
<thead>
					<tr>
						...
						<th>Display Agrupacion</th>
						<th>Accion</th>
					</tr>
</thead>					
<tbody>
				<?php
				$query= "Select * from \"servicios\".\"agrupacion\"";
					 ...
					 if($resp){
						 ...
						 if ($result) {
					 	 	while ($row = db2_fetch_array($result)) {
       						...
       						<td width="25%"><?php echo "<a onclick=\"eliminar('$row[0]','$row[1]','agrupacion')\">Eliminar</a>"; ?></td>
       						</tr><?php
      						}
						 }else{
