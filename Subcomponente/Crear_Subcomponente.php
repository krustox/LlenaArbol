...
<?php include('../head.php');?>
	<body>
		<div>
			...
			<div id="container">
			<h2>Crear Subcomponente</h2>
			<div class="formularios">
				<form action="newsubcomponente.php" method="post">
					<label>Holding</label>
				...
				?>
					...
					<label>Nombre Subomponente</label>
					<input type="text" name="display_subcomponente" id="display_subcomponente" />
