...
<?php include('../head.php');?>
	<body>
		<div id="wrapper">
			...
			<div id="container">
			<h2>Operacion</h2>
			<a href="Crear_Operacion.php">Crear Operacion</a>
			
				<table id="table">
<thead>
					<tr>
						<th>Nombre Transaccion</th>
						<th>Nombre Operacion</th>
						<th>Display Operacion</th>
						<th>Accion</th>
					</tr>
</thead>					
<tbody>
				<?php
				$query= "Select * from \"servicios\".\"operacion\"";
					 ...
					 if($resp){
						 ...
						 if ($result) {
					 	 	while ($row = db2_fetch_array($result)) {
       						...
       						<td width="25%"><?php echo "<a onclick=\"eliminar('$row[0]','$row[1]','operacion')\">Eliminar</a>"; ?></td>
       						</tr><?php
      						}
						 }else{
