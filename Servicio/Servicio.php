...
<html lang="en">
	...
	<body>
		<div id="wrapper">
			...
			<div id="container">
			<h2>Plataforma Aplicativa</h2>
			<a href="Crear_Servicio.php">Crear Plataforma Aplicativa</a>
...
<thead>
					<tr>
						...
						<th>Display Servicio</th>
						<th>Accion</th>
					</tr>
</thead>					
<tbody>
				<?php
				$query= "Select * from \"servicios\".\"servicio\"";
					 ...
					 if($resp){
						 ...
						 if ($result) {
					 	 	while ($row = db2_fetch_array($result)) {
       						...
       						<td width="25%"><?php echo "<a onclick=\"eliminar('$row[0]','$row[1]','servicio')\">Eliminar</a>"; ?></td>
       						</tr><?php
      						}
						 }else{
