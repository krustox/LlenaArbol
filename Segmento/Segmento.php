...
<?php include('../head.php');?>
	<body>
		<div id="wrapper">
			...
			<div id="container">
			<h2>Segmento</h2>
			<a href="Crear_Segmento.php">Crear Segmento</a>
...
<thead>
					<tr>
						...
						<th>Display Segmento</th>
						<th>Accion</th>
					</tr>
</thead>					
<tbody>
				<?php
				$query= "Select * from \"servicios\".\"segmento\"";
					 ...
					 if($resp){
						 ...
						 if ($result) {
					 	 	while ($row = db2_fetch_array($result)) {
       						...
       						<td width="25%"><?php echo "<a onclick=\"eliminar('$row[0]','$row[1]','segmento')\">Eliminar</a>"; ?></td>
       						</tr><?php
      						}
						 }else{
